...
const modes = {
    ...
    10: { name: "Camera Capture Mode", description: "Reduces missed pixels, filters all other tags" },
    11: { name: "Audio Capture Mode", description: "Reduces missed samples, filters all other tags" },
